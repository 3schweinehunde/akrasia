defmodule AkrasiaWeb.UserAuthTest do
  use AkrasiaWeb.ConnCase, async: true

  alias Akrasia.Accounts
  alias AkrasiaWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AkrasiaWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      AkrasiaWeb.Endpoint.subscribe(live_socket_id)
